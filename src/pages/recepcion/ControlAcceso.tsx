    ...
    <div className="space-y-6 max-w-lg mx-auto">
      ...
      {!sedeActivaId ? (
        ...
        <>
          {resultado ? (
            <div
              className={`rounded-xl p-6 border text-center space-y-2 ${
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg bg-background border border-line px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-primary"
                />
        ...
        {historial.length === 0 ? (
          ...
          <ul className="space-y-2">
            {historial.map((a) => (
              <li
                key={a.id}
                className="bg-surface rounded-lg px-3 py-2 border border-line flex items-center justify-between text-sm"
              >
