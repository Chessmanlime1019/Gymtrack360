...
export function QuickAccessMenu() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {abierto && (
        <div className="absolute right-0 mt-2 w-56 bg-surface border border-white/10 rounded-xl shadow-lg z-50 overflow-hidden">
          ...
          {items.map((item) => (
            <NavLink
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm text-white/80 hover:bg-white/5 hover:text-primary transition-colors"
            >
